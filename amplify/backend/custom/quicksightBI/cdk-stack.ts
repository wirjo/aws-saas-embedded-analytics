...
export class cdkStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps, amplifyResourceProps?: AmplifyHelpers.AmplifyResourceProps) {
    ...
    */
      ...
      /*
      // Create a "transactions" quicksight data source to Amazon Athena with "transactions" glue data catalog as the source
      const transactionsDataSource = new quicksight.CfnDataSource(this, 'transactionsDataSource', {
        awsAccountId: cdk.Aws.ACCOUNT_ID,
        dataSourceId: 'f8ad1f21-7c6c-4306-aa36-bc8e42bc35d4',
        name: 'transactionsDataSource',
        type: 'ATHENA',
        // Create a data source to Amazon Athena with "transactions" glue data catalog as the source
